...
urlpatterns = [
    ...
    url(r'^reclamos/crear$', views.crear_reclamo_sugerencia, name='crear_reclamo_sugerencia'),
    url(r'^reclamos/ver$', views.get_reclamo_sugerencia, name='get_reclamo_sugerencia'),
    ...
    url(r'^pedidos$', views.getPedidos, name='getPedidos'),
